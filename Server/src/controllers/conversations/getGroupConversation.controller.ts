...
import { getConversation } from "../../services/conversations/getGroupConversation.service.js";
import { errorResponse, successResponse } from "../../utils/response.js";

const { OK, BAD_REQUEST, INTERNAL_SERVER_ERROR } = HTTP_STATUS;

export const getGroupConversationController = async (
  req: Request,
  res: Response,
) => {
  try {
    ...
    const request = await getConversation({ userId });

    return successResponse(res, request, "Fetch groups.", OK);
  } catch (error) {
